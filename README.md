...
详见 `.ai/v3.5/V3_5_CLOSURE_SUMMARY.md`。

---

## V3.5 之外的额外联调问题

以下问题 **不属于 V3.5 主线**，而是独立联调问题：
...
- 客户自动回复链路不通
- 这是独立的 PlatformSim 联调问题

### conv1 / PlatformSim 实时链路验收

- 旧 mock 会话与 PlatformSim 的实时链路尚未在真实环境下完成全量验收
- 这是独立的联调验证问题

以上均不是 V3.5 主线未完成项。V3.5 本身已完成并封板。
...
V3.5 之外的额外联调问题（消息持久化 / PlatformSim 回复 / conv1 实时链路）是独立联调问题，不属于 V3.5 主线。
